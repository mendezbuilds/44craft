...
// Real social URLs (X/Discord/Telegram) aren't in SPEC.md yet — Section 13
// lists the community Discord/Telegram link as still open. Hrefs are "#"
// until those are decided; don't invent real-looking placeholder URLs.
// Icon paths are the standard public glyphs for each platform, not
// fabricated marks.
const SOCIALS = [
  {
    name: "X",
